...
import cn.dpc.provision.api.config.annotation.DeleteMessageMapping;
import cn.dpc.provision.api.config.annotation.GetMessageMapping;
import cn.dpc.provision.api.config.annotation.PostMessageMapping;
import cn.dpc.provision.api.config.annotation.PutMessageMapping;
